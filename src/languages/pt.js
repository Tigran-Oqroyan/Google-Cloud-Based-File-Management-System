const pt = {
  ...
  "Are you sure you want to delete all your files ?":
    "Tem certeza de que deseja excluir todos os seus arquivos?",
  ...
  "There is no uploaded files to show":
    "Não há arquivos enviados para mostrar.",
  "Choose a file or drag and drop it here":
    "Escolha um arquivo ou arraste e solte aqui.",
  "Browse File": "Carregar arquivo",
  "There is no uploaded files": "Não há arquivos enviados.",
  "Confirm Download": "Confirmar download",
  "Are you sure you want to download all your files ?":
    "Tem certeza de que deseja baixar todos os seus arquivos?",
  "Are you sure you want to download the selected files ?":
    "Tem certeza de que deseja baixar os arquivos selecionados?",
  "Are you sure you want to download this file ?":
    "Tem certeza de que deseja baixar este arquivo?",
  Uploaded: "Enviado",
  Failed: "Falhou",
  KB: "KB",
};
