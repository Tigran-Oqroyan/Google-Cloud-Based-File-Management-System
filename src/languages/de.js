const de = {
  ...
  "Are you sure you want to delete the selected files ?":
    "Möchten Sie die ausgewählten Dateien wirklich löschen?",
  "Are you sure you want to delete this file ?":
    "Möchten Sie diese Datei wirklich löschen?",
  "There is no uploaded files to show":
    "Keine hochgeladenen Dateien zum Anzeigen.",
  "Choose a file or drag and drop it here":
    "Wählen Sie eine Datei aus oder ziehen Sie sie hierher.",
  "Browse File": "Datei hochladen",
  "There is no uploaded files": "Keine hochgeladenen Dateien.",
  "Confirm Download": "Herunterladen bestätigen",
  "Are you sure you want to download all your files ?":
    "Möchten Sie wirklich alle Dateien herunterladen?",
  "Are you sure you want to download the selected files ?":
    "Möchten Sie die ausgewählten Dateien wirklich herunterladen?",
